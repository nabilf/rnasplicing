...
public abstract class GenericClassifier {
 private static Logger log = Logger.getLogger(GenericClassifier.class); 
	...
	public final void execute (Set<RNASequence> trainingSet, Set<RNASequence> testSet) throws ClassifierException {
		log.debug("Training Set Size" +trainingSet.size()); 
		setup(trainingSet, testSet); 
		work(trainingSet, testSet);  
	} 
	...
	protected abstract void work(Set<RNASequence> trainingSet, Set<RNASequence> testSet) throws ClassifierException;
}
