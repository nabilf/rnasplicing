...
import it.uniroma3.rnafolding.model.Element;
 ...
 *
 */
public class Nussinov implements FoldingAlgorithm {
	...
	private void init(String sequence) throws RNAFoldingException {
		if(sequence == null || sequence.length()==0){
			throw new RNAFoldingException("String sequence is null or empty ["+sequence+"]");
		}
